...
<form method="post" class="shadow">
  ...
  <div>
    ...
    <select name="departmentId">
      <option value="0">개설학과를 선택하세요</option>
  ...
  <div>
    <label>학점</label>
    <input type="number" name="unit" value="${ course.unit }" />
  </div>
  <div>
    <label>담당교수</label>
    <select name="professorId">
      <option value="0">담당교수를 선택하세요</option>
  ...
  <div>
    <label>시작일</label>
    <input type="date" name="startDate" value="${ course.startDate }" placeholder="yyyy-MM-dd" />
  </div>
  <div>
